...
#   c) node1 mines 32 blocks, so now node 0 has 60001azd, node 1 has 4250azd, node2 has none.
#   d) node0 sends 601 azd to node2, in two transactions (301 azd, then 300 azd).
