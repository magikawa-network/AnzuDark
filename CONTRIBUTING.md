Contributing to AnzuDark Core
============================

The AnzuDark Core project operates an open contributor model where anyone is
...
The following applies to code changes to the AnzuDark Core project, and is not to be
confused with overall AnzuDark Network Protocol consensus changes.

Whether a pull request is merged into AnzuDark Core rests with the project merge
...
Patches that change AnzuDark consensus rules are considerably more involved than
...
Where a patch set proposes to change the AnzuDark consensus, it must have been
...
The project leader is the release manager for each AnzuDark Core release.
