...
RESOURCES += src/qt/anzudark.qrc src/qt/anzudark_locale.qrc

TRANSLATIONS += src/qt/locale/anzudark_bg.ts \
                src/qt/locale/anzudark_de.ts \
                src/qt/locale/anzudark_en.ts \
                src/qt/locale/anzudark_es.ts \
                src/qt/locale/anzudark_fi.ts \
                src/qt/locale/anzudark_fr.ts \
                src/qt/locale/anzudark_it.ts \
                src/qt/locale/anzudark_ja.ts \
                src/qt/locale/anzudark_pl.ts \
                src/qt/locale/anzudark_pt.ts \
                src/qt/locale/anzudark_ru.ts \
                src/qt/locale/anzudark_sk.ts \
                src/qt/locale/anzudark_sv.ts \
                src/qt/locale/anzudark_vi.ts \
                src/qt/locale/anzudark_zh_CN.ts \
                src/qt/locale/anzudark_zh_TW.ts
