...
This means one can have an always-on anzudarkd instance running, and another local anzudarkd/anzudark-qt instance which connects to this node and receives blocks from it.
