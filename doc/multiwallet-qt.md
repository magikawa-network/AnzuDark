...
In order to support loading of multiple wallets in anzudark-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is anzudark.cpp.
...
Changes to anzudark.cpp
----------------------
anzudark.cpp is the entry point into anzudark-qt, and as such, will require some minor modifications to provide hooks for
