...
/**
 * AnzuDark RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzazdseed(const UniValue& params, bool fHelp);
extern UniValue getzazdseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzazd(const UniValue& params, bool fHelp);
extern UniValue dzazdstate(const UniValue& params, bool fHelp);
