...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Anzudark Core anzudark-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  anzudark-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded anzudark transaction") + "\n" +
                               "  anzudark-tx [options] -create [commands]   " + _("Create hex-encoded anzudark transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded anzudark transaction
