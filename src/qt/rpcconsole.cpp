                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzAZDPathCustom = GetArg("-zazdbackuppath", "");
    ...
    if(!strzAZDPathCustom.empty()) {
        ui->wallet_customzazdbackuppath->setText(QString::fromStdString(strzAZDPathCustom));
        ui->wallet_customzazdbackuppath_label->setVisible(true);
        ui->wallet_customzazdbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzAZDPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the AnzuDark RPC console.") + "<br>" +
