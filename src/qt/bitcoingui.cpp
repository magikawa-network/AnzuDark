                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("AnzuDark Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a AnzuDark address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and anzudark: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zAZD"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About AnzuDark Core"), this);
    aboutAction->setStatusTip(tr("Show information about AnzuDark Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for AnzuDark"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your AnzuDark addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified AnzuDark addresses"));
    ...
    openAction->setStatusTip(tr("Open a AnzuDark: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the AnzuDark Core help message to get a list with possible AnzuDark command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("AnzuDark Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to AnzuDark network", "", count));
}
...
{
    QString strTitle = tr("AnzuDark Core"); // default title
