...
/** Utility functions used by the AnzuDark Qt UI.
 */
namespace GUIUtil
{
...
// Render AnzuDark addresses in monospace font
...
// Parse "anzudark:" URI into recipient object, return true on successful parsing
