...
/* Anzudark GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "AnzuDark"
#define QAPP_ORG_DOMAIN "anzudark.org"
#define QAPP_APP_NAME_DEFAULT "AnzuDark-Qt"
#define QAPP_APP_NAME_TESTNET "AnzuDark-Qt-testnet"
