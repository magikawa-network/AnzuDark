...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("AnzuDark Core"),
     ...
     * override -datadir in the anzudark.conf file in the default data directory
     * (to be consistent with anzudarkd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
