...
#ifndef AnzuDark_ZAZDWALLET_H
#define AnzuDark_ZAZDWALLET_H
...
public:
    CzAZDWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZAZD(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZAZD(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //AnzuDark_ZAZDWALLET_H
